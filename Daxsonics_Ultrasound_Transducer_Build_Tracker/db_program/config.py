...
try:
    ...
    table_file = open("/Users/jiahaochen/Downloads/SNYProject/Daxsonics_Ultrasound_Transducer_Build_Tracker/db_program/json/table.json", "r")
except:
...
try:
    ...
    input_pattern_file = open("/Users/jiahaochen/Downloads/SNYProject/Daxsonics_Ultrasound_Transducer_Build_Tracker/db_program/json/input_pattern.json", "r")
except:
    input_pattern_file = open("json/input_pattern.json", "r")
